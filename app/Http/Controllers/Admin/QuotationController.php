                  ...
                  <div class="row contacts">
                      ...
                      <div class="col invoice-to">
                        ...
                        <div class="text-gray-light "><b>As per quotation regarding the '.$divice.', we are
                            ...
                            <br> <div class="text-gray-light">Patient Name : '. $pronounced.'.'.$name.'</div>
                            <div class="text-gray-light">Diagnosis : '. $diagnosis.'</div>
                            <div class="text-gray-light">Prescription : '.$prescription.'</div>
                            <br>
                            <div class="text-gray-light"><b>Fitment and ADL Training Charges : Free of Charge</b></div>
                            <div class="text-gray-light">Warranty : '.$warranty.'. </div>
                            <div class="text-gray-light">Delivery :'.$deliverydate.' </div>
                            <div class="text-gray-light">Price Validity : '.$pricevalidity.' </div>
                            <div class="text-gray-light">Payment method :'. $paymentmethod.' </div>

                            <div class="text-gray-light">Purchase Order to be issued to: Artificial limb care Pvt Ltd. </div>
                          
                            <div class="text-gray-light" style="padding-left: 15px;">• '.$divice.'=Rs.'.$price.'</div>
                            <br>
                            <div class="text-gray-light">*price above include with service and training.  </div>
                            <br>
